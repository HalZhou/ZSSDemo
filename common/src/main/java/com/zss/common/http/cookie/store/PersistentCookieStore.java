package com.zss.common.http.cookie.store;
...
public class PersistentCookieStore implements CookieStore {
    ...
    public PersistentCookieStore(Context context) {
        ...
        cookies = new HashMap<>();
        //Map<"enocloud.enoch-car.com",CurrentHashMap<"SSO_TOKEN@enocloud.enoch-car.com",Cookie>>
    ...
    /** 将url的所有Cookie保存在本地
     * url.host = "enocloud.enoch-car.com"*/
    @Override
    ...
    private void saveCookie(HttpUrl url, Cookie cookie, String name) {
        //内存缓存
        if (Constants.SSO_TOKEN.equalsIgnoreCase(cookie.name()) || Constants.ENOCH_BRANCH.equalsIgnoreCase(cookie.name()) || Constants.ENOCH_TENANT.equalsIgnoreCase(cookie.name())) {
